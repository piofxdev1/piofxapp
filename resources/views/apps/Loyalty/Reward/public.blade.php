...
<html lang="en">
	...
	<body style="max-width= 100vw; overflow-x: hidden; background: #fff6cc;">
        ...
        <div class="container-fluid d-flex justify-content-center text-center text-lg-left my-5">
            <div class="row loyalty_main">
                <div class="col-12 col-lg-6 d-flex justify-content-center align-items-center" style="min-height: 15rem;">
                    <div>
                        <h1 class="text-muted">There's only one thing that matters</h1>
                ...
                <div class="col-12 col-lg-6 mt-5 mt-lg-0">
                    <img src="{{ asset('img/Giveaway.png') }}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid my-5" style="max-width: 100rem;">
            ...
            <form action="{{ route($app->module.'.public') }}" class="mt-5 p-5 pt-8" id="reward_form" style="background: #fceeb0; border-radius: 2rem;">
            ...
            @if($objs ?? "")
                @if($remaining_credits ?? '')
                    <div class="container bg-white rounded-lg p-5 mt-7" style="max-width: 100rem;">
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <div class="">
                                            <div class="d-flex align-items-center">
                                                <h1 class="font-weight-bolder mr-3 d-flex align-items-center">{{ $remaining_credits }} Points</h1>
                                            </div>
                ...
                @else
                    @auth
                        <div class="p-5 mt-5 bg-white text-dark rounded shadow"  style="max-width: 80rem;">
