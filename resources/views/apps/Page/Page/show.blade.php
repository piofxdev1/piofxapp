...
<x-dynamic-component :component="$app->componentName" class="mt-4" >
	...
	<x-snippets.cards.basic>
		...
		<div class="row mb-2">
			...
			<div class="col-md-8">{{ $obj->slug }} <a href="http://{{$obj->client->domain}}/{{ $obj->slug }}" target="_blank" class="pl-3"><i class="flaticon-paper-plane text-primary"></i> view page</a></div>
		</div>
		<div class="row mb-2">
