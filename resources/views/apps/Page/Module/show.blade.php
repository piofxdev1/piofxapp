...
<x-dynamic-component :component="$app->componentName" class="mt-4" >
	...
	<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-4 font-size-sm ">
      ...
      <li class="breadcrumb-item">
        <a href="{{ route('Module.index',$app->id) }}"  class="text-muted">Modules</a>
      </li>
      <li class="breadcrumb-item">
	...
	<div class="tab-content mt-5" id="myTabContent">
		...
		@if(!$settings)
			No Settings defined
		@else
			<form method="post" action="{{route('Module.save',[$app->id,$obj->id])}}" enctype="multipart/form-data">
		...
		<div class="tab-pane fade" id="developer" role="tabpanel" aria-labelledby="developer-tab">
				<div class="row mb-2">
					<div class="col-6 col-md-4"><b>Name</b></div>
					<div class="col-6 col-md-8">{{ $obj->name }}</div>
				</div>
				<div class="row mb-2">
					<div class="col-6 col-md-4"><b>Slug</b></div>
					<div class="col-6 col-md-8">{{ $obj->slug }} </div>
				</div>
				<div class="row mb-2">
					<div class="col-6 col-md-4"><b>Client</b></div>
					<div class="col-6 col-md-8">{{ $obj->client->name }} ({{ $obj->client->domain }})</div>
				</div>
				<div class="row mb-2">
				...
				<div class="row mb-2">
					...
					<div class="col-6 col-md-8">@if($obj->status==0)
				...
				<div class="row mb-2">
					<div class="col-6 col-md-4"><b>Created At</b></div>
					<div class="col-6 col-md-8">{{ ($obj->created_at) ? $obj->created_at->diffForHumans() : '' }}</div>
				</div>
		</div>
	</div>
