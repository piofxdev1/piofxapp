        ...
        <x-snippets.cards.action :title="$app->module " class="border"  >
              <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="name" class="form-control"  placeholder="name" name="name" value="@if($stub == 'Update'){{$obj ? $obj->name : ''}}@endif">
                  </div>
                  <div class="form-group col-md-6">
                      <h6 for="inputPassword4">Slug</h6>
                      <input type="slug" class="form-control" id="inputPassword4" placeholder="slug" name="slug" value="@if($stub == 'Update'){{$obj ? $obj->slug : ''}}@endif">
                  </div>
              </div>
              <div class="form-row">
                  <div class="form-group col-md-6">
              ...
              <div class="form-row">
                  <div class="form-group col-md-6">
                      <h6 for="inputCity">Index Screenshots</h6>
