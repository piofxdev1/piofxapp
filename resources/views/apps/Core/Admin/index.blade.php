				...
				<div class='col-6 col-md-4'>
					...
					<div class="card card-custom   gutter-b" style="max-height: 150px;background:#ff5500;">
						<div class="card-body">
							<span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
								<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
								<span class="svg-icon svg-icon-light svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-02-01-052524/theme/html/demo1/dist/../src/media/svg/icons/Design/Brush.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24"/>
							...
							<div>
								<a href="{{ url('admin/theme')}}" class="text-inverse-success font-weight-bolder font-size-h4 mt-3">Themes</a>
							</div>
						</div>
					</div>
					<!--end::Tiles Widget 11-->
