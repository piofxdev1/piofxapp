		...
		<div class="col-12 col-md-8">
			...
			<h4 class="mb-6">
				...
				<div class="row">
					...
					<div class='col-6 col-md-4'>
						<!--begin::Tiles Widget 11-->
						<div class="card card-custom gutter-b" style="max-height: 150px;background:#e91e63;">
							<div class="card-body">
								<span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
									<span class="svg-icon svg-icon-white svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-02-01-052524/theme/html/demo1/dist/../src/media/svg/icons/Communication/Mail-opened.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24"/>
								...
								<div>
									<a href="{{ url('admin/mailer')}}" class="text-inverse-success font-weight-bolder font-size-h4 mt-3">Mailer</a>
								</div>
							</div>
						</div>
						<!--end::Tiles Widget 11-->
					...
					<div class='col-6 col-md-4'>
						<!--begin::Tiles Widget 11-->
						<div class="card card-custom gutter-b" style="max-height: 150px;background:#607d8b;">
							<div class="card-body">
								<span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
									<span class="svg-icon svg-icon-white svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-02-01-052524/theme/html/demo1/dist/../src/media/svg/icons/Design/Pixels.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24"/>
								...
								<div>
									<a href="{{ url('admin/crm')}}" class="text-inverse-success font-weight-bolder font-size-h4 mt-3">CRM</a>
								</div>
							</div>
						</div>
						<!--end::Tiles Widget 11-->
					...
					<div class='col-6 col-md-4'>
						<!--begin::Tiles Widget 11-->
						<div class="card card-custom gutter-b" style="max-height: 150px;background:#1977a5;">
							<div class="card-body">
								<span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
									<span class="svg-icon svg-icon-white svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-02-01-052524/theme/html/demo1/dist/../src/media/svg/icons/General/Like.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24"/>
								...
								<div>
									<a href="{{ url('admin/social')}}" class="text-inverse-success font-weight-bolder font-size-h4 mt-3">Social</a>
								</div>
							</div>
						</div>
						<!--end::Tiles Widget 11-->
					...
					<div class='col-6 col-md-4'>
						<!--begin::Tiles Widget 11-->
						<div class="card card-custom  gutter-b" style="max-height: 150px;background:#11cee6;">
							<div class="card-body">
								<span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
									<span class="svg-icon svg-icon-white svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-02-01-052524/theme/html/demo1/dist/../src/media/svg/icons/Shopping/Cart2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24"/>
								...
								<div>
									<a href="{{ url('admin/shop')}}" class="text-inverse-success font-weight-bolder font-size-h4 mt-3">Shop</a>
								</div>
							</div>
						</div>
						<!--end::Tiles Widget 11-->
