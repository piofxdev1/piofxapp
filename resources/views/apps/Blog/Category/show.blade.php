<x-dynamic-component :component="$app->componentName">
  ...
  <main id="content" role="main">
    ...
    <div class="bg-dark space-top-3 d-flex justify-content-center align-items-center"
        style="background-image: url({{ url('/').'/storage/'.$category->image }}); background-position: center; background-size: cover; background-repeat: no-repeat;min-height: 30rem;">
      <div class="text-center">
        <h1><span class="bg-dark px-3 py-2 rounded-lg text-warning">{{ $category->name }}</span></h1>
        @if($category->meta_description)
          <div class="bg-dark mt-3 p-3 rounded-lg">
